...
b1 = Button(f1, text='Add Faculty', command=add_fac, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
...
b2 = Button(f2, text='Remove/Update Details of Faculty', command = change_details, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
