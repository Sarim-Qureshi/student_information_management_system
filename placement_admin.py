...
def add_placeofficer():
    os.system('placementadd_admin.py')


def change_placeofficer():
    os.system('placement2_admin.py')
...
head = Label(root, text='Modify Placement Cell', font='consolas 30 bold')
head.pack(pady=(35, 0))
...
b1 = Button(f1, text='Add Placement Officer', command=add_placeofficer, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
...
b2 = Button(f2, text='Remove/Update Details of Placement Officer', command = change_placeofficer, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
