...
def add_examofficer():
    os.system('facultyadd_admin.py')


def change_details():
    os.system('faculty2_admin.py')
...
head = Label(root, text='Exam Officer', font='consolas 30 bold')
head.pack(pady=(35, 0))
...
b1 = Button(f1, text='Add Exam Officer', command=add_examofficer, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
...
b2 = Button(f2, text='Remove/Update Details of Exam Officer', command = change_details, cursor='hand2', font='consolas 14 bold', pady=1, padx=10)
